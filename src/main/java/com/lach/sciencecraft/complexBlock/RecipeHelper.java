...
public class RecipeHelper {
	...
	public static IRecipe findMatchingRecipe(
		...
		if (itemNum == 2 && item1.getItem() == item2.getItem()
			...
			int item1Durability = itemBase.getMaxDamage()
					- item1.getItemDamageForDisplay();
			int item2Durability = itemBase.getMaxDamage()
					- item2.getItemDamageForDisplay();
			int repairAmt = item1Durability + item2Durability
					+ itemBase.getMaxDamage() * 5 / 100;
			...
			return new ShapelessRecipes(new ItemStack(item1.getItem(), 1,
					newDamage), ingredients);
		}
